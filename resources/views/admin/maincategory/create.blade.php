                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.maincat.store')}}"
                                          method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <img src="{{asset('assets/images/maincategories/cat.png')}}"  style="width:100px" class="img-thumbnail image-preview"alt="">
                                            ...
                                            @if(get_language() -> count() > 0)
                                                @foreach(get_language() as $index => $lang)
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> Name of MainCategory {{__('messages.'.$lang -> abbr)}} </label>
                                                        ...
                                                        <div class="col-md-6 mt-2">
                                                            <div class="form-group mt-1">
                                                                ...
                                                                <label for="switcheryColor4"
                                                                       class="card-title ml-1">Status  {{__('messages.'.$lang -> abbr)}} </label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 hidden">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> Abbreviations {{__('messages.'.$lang -> abbr)}} </label>
