    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">Welcome page
                  <span
                      class="user-name text-bold-700">abdallah hesham</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="{{asset('assets/admin/images/logo/default.png')}}" alt="avatar"><i></i></span>
                        </a>
